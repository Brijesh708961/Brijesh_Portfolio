            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className='text-center mb-5'>
                    ...
                    <p className='text-xl max-w-3xl mx-auto mb-6'>
                        Mastering the tools that power modern web experience.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                    {skillsData.map((skill, index) => (
                        <div key={index} className="p-6 border bg-teal-50/10 border-teal-700 rounded-xl text-center cursor-pointer hover:border-b-4 hover:border-b-teal-800 hover:border-r-4 hover:border-r-teal-800 hover:translate-y-1 transition-all direaction-300">
